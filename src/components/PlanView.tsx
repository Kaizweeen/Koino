...
export function PlanView({ slug }: { slug: string }) {
  ...
  return (
    <div className="fade-in mx-auto flex w-full max-w-5xl flex-col gap-5 p-5 pb-6 lg:gap-7 lg:px-10 lg:py-12" style={{ ["--accent" as string]: t.accent }}>
      ...
      <ol className="flex flex-col gap-3 lg:grid lg:grid-cols-2 lg:gap-4">
        {devs.map((d, i) => (
      ...
      <Link href="/app/today" className="btn-primary block rounded-full py-3.5 text-center text-[15px] font-medium lg:mx-auto lg:mt-2 lg:w-fit lg:px-10">
